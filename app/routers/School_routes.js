...
router.post('/api/v1/school',auth.validateToken,validateCreateSchool, checkExistedSchool, SchoolController.createSchool);
router.get('/api/v1/school/:id',auth.validateToken, SchoolController.allSchoolId);
router.put('/api/v1/school/:id', auth.validateToken,SchoolController.updateSchool );
router.delete('/api/v1/school/:id',auth.validateToken, SchoolController.deleteSchool);
